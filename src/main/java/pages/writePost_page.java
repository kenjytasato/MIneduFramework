...
public class writePost_page {
    ...
    @FindBy(xpath = "//*[@id='content']/div/div[5]/main/aside/div[1]/div[2]/div[1]/button")
    WebElement postNSFWbtn;


    @FindBy(xpath = "//*[@id='content']/div/div[5]/main/aside/div[1]/div[2]/form[1]/input")
    WebElement postTags;
    ...
    @FindBy(xpath = "//*[@id='content']/div/div[5]/main/main/div/div[2]/div[1]/div/div/div[1]/span")
    WebElement channel;
    @FindBy(xpath = "//*[@id='content']/div/div[5]/main/main/div/div[2]/div[1]/div/div/div[2]/div[1]/input")
    WebElement channelText;
    @FindBy(xpath = "//*[@id='content']/div/div[5]/main/main/div/div[2]/div[1]/div/div/div[2]/ul[2]/li[1]/div[1]/span[2]")
    ...
    public void setPostBody() {
        String body = "esta es una prueba esta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una pruebaesta es una prueba";


        postBody.sendKeys(postContent);
